                            ...
                            {user.companies_owned.length === 0 ? (
                              ...
                              <div className="space-y-2">
                                {user.companies_owned.map(company => (
                                  ...
                                  >
                                    <div className="w-6 h-6 bg-primary-orange/20 rounded flex items-center justify-center">
                                ...
                                {user.team_memberships.map((membership, idx) => (
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-white text-sm truncate">{membership.company_name}</span>
                                    </div>
