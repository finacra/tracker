...
-- Configuration:
-- Project Reference: aqziojkjtmyecfglifbc
-- Using anon key for authorization
...
-- ============================================
-- NOTE: This script has been configured with your actual values.
-- The cron job is set to run every hour and call the Edge Function.
-- ============================================
