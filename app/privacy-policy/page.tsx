          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            ...
            <ul className="space-y-3 list-none">
              <li className="flex items-start gap-3">
                ...
                <span className="text-fg-secondary font-light">Where we need to perform the contract we are about to enter into or have entered into with you.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-fg-muted mt-1">✓</span>
                <span className="text-fg-secondary font-light">Where it is necessary for our legitimate interests (or those of a third party) and your interests and fundamental rights do not override those interests.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-fg-muted mt-1">✓</span>
                <span className="text-fg-secondary font-light">Where we need to comply with a legal obligation.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            ...
            <div className="bg-bg-elevated/50 border border-line/15 p-5 rounded-xl mt-4">
              <p className="text-fg-secondary font-light">
                <strong className="text-fg-secondary font-light">Note:</strong> We use industry-standard encryption and security protocols to protect your data. All compliance documents and sensitive information are stored securely with access controls.
              </p>
            </div>
          </section>
