      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-bg-elevated border border-line/15 rounded-xl flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-fg-muted">
            ...
            <h1 className="text-5xl font-light text-fg-primary">Terms of Service</h1>
          </div>
        ...
        <div className="space-y-8 bg-bg-card p-8 md:p-12 rounded-xl border border-line/10">
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            ...
            <p className="text-fg-secondary leading-relaxed text-lg mb-4 font-light">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <span className="text-fg-muted mt-1">✗</span>
                <span className="text-fg-secondary font-light">Modify or copy the materials</span>
              </div>
              <div className="flex items-start gap-3 bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <span className="text-fg-muted mt-1">✗</span>
                <span className="text-fg-secondary font-light">Use the materials for any commercial purpose, or for any public display (commercial or non-commercial)</span>
              </div>
              <div className="flex items-start gap-3 bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <span className="text-fg-muted mt-1">✗</span>
                <span className="text-fg-secondary font-light">Attempt to decompile or reverse engineer any software contained on Finacra AI's website</span>
              </div>
              <div className="flex items-start gap-3 bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <span className="text-fg-muted mt-1">✗</span>
                <span className="text-fg-secondary font-light">Remove any copyright or other proprietary notations from the materials</span>
              </div>
              <div className="flex items-start gap-3 bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <span className="text-fg-muted mt-1">✗</span>
                <span className="text-fg-secondary font-light">Transfer the materials to another person or "mirror" the materials on any other server</span>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-bg-card/50 p-5 rounded-xl border border-line/10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-fg-primary font-light">Compliance Tracking</h3>
                </div>
                <p className="text-fg-muted text-sm font-light">Regulatory deadline tracking and management</p>
              </div>
              <div className="bg-bg-card/50 p-5 rounded-xl border border-line/10">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 bg-primary-orange/20 rounded-lg flex items-center justify-center">
                  ...
                  <h3 className="text-fg-primary font-light">Document Management</h3>
                </div>
                <p className="text-fg-muted text-sm font-light">Secure document storage and organization</p>
              </div>
              <div className="bg-bg-card/50 p-5 rounded-xl border border-line/10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-fg-primary font-light">Reporting</h3>
                </div>
                <p className="text-fg-muted text-sm font-light">AI-powered compliance reports and insights</p>
              </div>
              <div className="bg-bg-card/50 p-5 rounded-xl border border-line/10">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 bg-bg-elevated border border-line/15 rounded-lg flex items-center justify-center">
                  ...
                  <h3 className="text-fg-primary font-light">GST Integration</h3>
                </div>
                <p className="text-fg-muted text-sm font-light">Automated GST return management</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            ...
            <div className="bg-bg-elevated/50 border border-line/15 p-5 rounded-xl mt-4">
              <p className="text-fg-secondary font-light">
                <strong className="text-fg-secondary font-light">Important:</strong> While we strive to provide accurate compliance information, you should always verify regulatory requirements with qualified professionals. Finacra AI is not a substitute for professional legal or financial advice.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            ...
            <div className="space-y-3">
              <div className="bg-bg-card/50 p-4 rounded-lg border border-line/10">
                <p className="text-fg-primary font-light mb-2">You are responsible for:</p>
                <ul className="space-y-2 text-fg-secondary text-sm list-disc list-inside font-light">
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            <h2 className="text-3xl font-light text-fg-primary mb-4 flex items-center gap-3">
              <span className="w-8 h-8 bg-bg-elevated border border-line/15 rounded-lg flex items-center justify-center text-fg-muted text-lg font-light">7</span>
              Governing Law
            </h2>
            <p className="text-fg-secondary leading-relaxed text-lg font-light">
          ...
          <section className="space-y-4 pt-8 border-t border-line/10">
            <h2 className="text-3xl font-light text-fg-primary mb-4 flex items-center gap-3">
              <span className="w-8 h-8 bg-bg-elevated border border-line/15 rounded-lg flex items-center justify-center text-fg-muted text-lg font-light">8</span>
              Contact Us
            </h2>
            <p className="text-fg-secondary leading-relaxed text-lg mb-4 font-light">
